...
const McpView = ({ onDone }: McpViewProps) => {
  ...
  const [activeTab, setActiveTab] = useState(
    mcpMarketplaceEnabled ? 'marketplace' : 'installed'
  );
          ...
          {activeTab === 'installed' && (
            <div style={{ padding: '16px 20px' }}>
              ...
              >
                ...
                provide additional tools and resources to extend Apex's
                ...
                or ask Apex to create new tools specific to your workflow (e.g.,
          ...
          >
            <div
              style={{
                ...
                border:
                  '1px solid color-mix(in srgb, #666666 65%, transparent)',
                borderRadius: '50%',
                position: 'absolute',
                top: '1px',
