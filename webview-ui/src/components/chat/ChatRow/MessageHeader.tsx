        ...
        switch (type) {
            case "error":
                return [
                    ...
                    <span key="title" style={{ color: errorColor, fontWeight: "bold" }}>Error</span>,
                ];
            case "mistake_limit_reached":
                return [
                    ...
                    <span key="title" style={{ color: errorColor, fontWeight: "bold" }}>Apex is having trouble...</span>,
                ];
            case "auto_approval_max_req_reached":
                return [
                    ...
                    <span key="title" style={{ color: errorColor, fontWeight: "bold" }}>Maximum Requests Reached</span>,
                ];
            case "command":
                return [
                    isCommandExecuting ? (
                    ...
                    <span key="title" style={{ color: normalColor, fontWeight: "bold" }}>Apex wants to execute this command:</span>,
                ];
            case "use_mcp_server":
                ...
                try {
                    ...
                    return [
                        <span key="icon" className="codicon codicon-error" style={{ color: errorColor, marginBottom: "-1.5px" }}></span>,
                        <span key="title" style={{ color: errorColor, fontWeight: "bold" }}>Invalid MCP Request</span>
                    ];
                }
            ...
            case "completion_result":
                return [
                    ...
                    <span key="title" style={{ color: successColor, fontWeight: "bold" }}>Task Completed</span>,
                ];
                    ...
                    (() => {
                        if (apiReqCancelReason != null) {
                            return apiReqCancelReason === "user_cancelled" ? (
                                <span key="title" style={{ color: normalColor, fontWeight: "bold" }}>API Request Cancelled</span>
                            ) : (
                                <span key="title" style={{ color: errorColor, fontWeight: "bold" }}>API Streaming Failed</span>
                            );
                        }

                        if (cost != null) {
                            return <span key="title" style={{ color: normalColor, fontWeight: "bold" }}>API Request</span>;
                        }

                        if (apiRequestFailedMessage) {
                            return <span key="title" style={{ color: errorColor, fontWeight: "bold" }}>API Request Failed</span>;
                        }
            ...
            case "followup":
                return [
                    ...
                    <span key="title" style={{ color: normalColor, fontWeight: "bold" }}>Apex has a question:</span>,
                ];
            default:
