    ...
    case 'say':
      switch (message.say) {
        ...
        case 'shell_integration_warning':
          ...
          return (
            ...
            >
              ...
              ></i>
              Shell Integration Unavailable: {message.text}{' '}
              {/* Adjust as needed */}
            </div>
          );
        case 'diff_error':
          return (
            ...
            >
              <i
                ...
                style={{ marginRight: '8px' }}
              ></i>
              Diff Edit Mismatch: The model used search patterns that don't
              match anything in the file. Retrying...
            </div>
          );
          ...
          return (
            ...
            >
              <i
                ...
                style={{ marginRight: '8px' }}
              ></i>
              Access Denied: Apex tried to access <code>{message.text}</code>{' '}
              which is blocked by the <code>.apexignore</code> file.
            </div>
          );
        ...
        default:
          ...
          console.warn(
            "Unhandled 'say' type in DefaultMessageRenderer:",
            message.say
          );
    ...
    case 'ask':
      switch (message.ask) {
        ...
        default:
          ...
          console.warn(
            "Unhandled 'ask' type in DefaultMessageRenderer:",
            message.ask
          );
          return message.text ? <Markdown markdown={message.text} /> : null;
      }
