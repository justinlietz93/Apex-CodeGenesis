            ...
            switch (message.say) {
                ...
                // Add cases for 'info', 'shell_integration_warning', 'diff_error', 'apexignore_error', 'checkpoint_created' if they should be handled here
                 ...
                 case "shell_integration_warning":
                    ...
                    return (
                         <div style={{ color: 'var(--vscode-warningForeground)', fontSize: '12px', padding: '8px', backgroundColor: 'rgba(255, 191, 0, 0.1)', borderRadius: '3px' }}>
                 ...
                 case "diff_error":
                     return (
                         <div style={{ color: 'var(--vscode-warningForeground)', fontSize: '12px', padding: '8px', backgroundColor: 'var(--vscode-textBlockQuote-background)', borderRadius: '3px' }}>
                             <i className="codicon codicon-warning" style={{ marginRight: '8px' }}></i>
                 ...
                 case "apexignore_error":
                     return (
                         <div style={{ color: '#FFA500', fontSize: '12px', padding: '8px', backgroundColor: 'rgba(255, 191, 0, 0.1)', borderRadius: '3px' }}>
                             <i className="codicon codicon-error" style={{ marginRight: '8px' }}></i>
                             Access Denied: Apex tried to access <code>{message.text}</code> which is blocked by the <code>.apexignore</code> file.
                         </div>
                     );
