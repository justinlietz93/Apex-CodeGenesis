...
import { ApexAskUseMcpServer, ApexMessage, McpServer, McpMarketplaceCatalog } from '../../../../../src/shared/ExtensionMessage';
                        ...
                        <div onClick={(e) => e.stopPropagation()}>
                            <McpToolRow
                                tool={{
                                    ...
                                    description:
                                        server?.tools?.find((tool: { name: string }) => tool.name === useMcpServer?.toolName)?.description || "",
                                    autoApprove:
                                        server?.tools?.find((tool: { name: string }) => tool.name === useMcpServer?.toolName)?.autoApprove ||
                                        false,
                                }}
