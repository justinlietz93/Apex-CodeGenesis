		...
		<>
			<div
				...
				<div style={{ padding: "15px 15px 0 15px" }}>
					...
					<p style={{ marginTop: 0, marginBottom: 15, opacity: 0.7 }}>v{version}</p>
					{/* TODO: Fix prop types for child components */}
					{/* <TelemetryBanner {...({ telemetrySetting } as any)} /> */} {/* Disabled telemetry banner */}
					{showAnnouncement && <Announcement {...({ onClose: hideAnnouncement } as any)} />}
				</div>
