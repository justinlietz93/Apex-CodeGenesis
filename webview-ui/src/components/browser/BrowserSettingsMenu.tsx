...
export const BrowserSettingsMenu: React.FC<BrowserSettingsMenuProps> = ({
  disabled = false,
  maxWidth,
}) => {
          ...
          {/* <SettingsGroup>
						...
						<SettingsDescription>
							{browserSettings.chromeType === "system" ? (
								<>
									Apex will use your personal browser. You must{" "}
									<VSCodeLink
										href="#"
								...
								"Apex will use a Chromium browser bundled with the extension."
							)}
						</SettingsDescription>
					</SettingsGroup> */}
...
const SettingsMenu = styled.div<{ maxWidth?: number }>`
  ...
  min-width: 0px;
  max-width: ${(props) =>
    props.maxWidth ? `${props.maxWidth - 23}px` : '100vw'};
