  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          Leveraging advanced agentic capabilities, I can perform complex
          ...
          <ul>
            ...
            <li>
              Recursive chain-of-thought reasoning for complex problem-solving
            </li>
            <li>Dynamic persona utilization for specialized task handling</li>
            <li>Full autonomy modes for independent operation</li>
          </ul>
          I utilize a suite of tools for file manipulation, code execution,
          browsing, and can be extended via the Model Context Protocol (MCP).
        </p>
