...
import { ApexCheckpointRestore } from '../../../../src/shared/WebviewMessage';
            ...
            createPortal(
              ...
              >
                <RestoreOption>
                  ...
                  <p>
                    Restores your project's files back to a snapshot taken at
                    this point (use "Compare" to see what will be reverted)
                  </p>
                </RestoreOption>
                <RestoreOption>
                  <VSCodeButton
                ...
                <RestoreOption>
                  ...
                  <p>
                    Restores your project's files and deletes all messages after
                    this point
                  </p>
                </RestoreOption>
              </RestoreConfirmTooltip>,
