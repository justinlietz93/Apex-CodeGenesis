	...
	*/
	...
	return (
		<div style={{ display: "flex", flexDirection: "column", gap: 5, marginBottom: isPopup ? -10 : 0 }}>
				...
				<div>
					...
					<p
						...
						<span style={{ color: "var(--vscode-errorForeground)" }}>
							(<span style={{ fontWeight: 500 }}>Note:</span> Apex uses complex prompts and works best with Claude
			...
			{(selectedProvider === "openrouter" || selectedProvider === "apex") && showModelOptions && (
				<>
					<VSCodeCheckbox
						style={{ marginTop: -10 }}
