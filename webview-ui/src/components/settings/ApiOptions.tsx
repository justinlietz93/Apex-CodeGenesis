...
import { ApexAccountInfoCard } from './ApexAccountInfoCard'; // Correct import path after rename
  ...
  return (
    ...
    >
      <DropdownContainer className="dropdown-container">
        ...
        >
          <VSCodeOption value="apex">Apex</VSCodeOption>
        ...
        <div>
          ...
          >
            ...
            >
              ...
              <VSCodeOption value="international">
                International API
              </VSCodeOption>
            </VSCodeDropdown>
          </DropdownContainer>
          ...
          >
            ...
            If you are in China, choose the China API interface. Otherwise,
            choose the International API interface.
          </p>
          <VSCodeTextField
      ...
      {selectedProvider === 'bedrock' && (
        ...
        >
          ...
          >
            {apiConfiguration?.awsUseProfile ? (
              <>
                Using AWS Profile credentials from ~/.aws/credentials. Leave
                profile name empty to use the default profile. These credentials
                are only used locally to make API requests from this extension.
              </>
            ) : (
              <>
                Authenticate by either providing the keys above or use the
                default AWS credential providers, i.e. ~/.aws/credentials or
                environment variables. These credentials are only used locally
        ...
        <div>
          ...
          {modelConfigurationSelected && (
            <>
              ...
              <VSCodeCheckbox
                checked={
                  !!apiConfiguration?.openAiModelInfo?.supportsComputerUse
                }
                onChange={(e: any) => {
                  const isChecked = e.target.checked === true;
              ...
              <VSCodeCheckbox
                checked={
                  !!apiConfiguration?.openAiModelInfo?.isR1FormatRequired
                }
                onChange={(e: any) => {
                  const isChecked = e.target.checked === true;
                  let modelInfo = apiConfiguration?.openAiModelInfo
          ...
          >
            <span style={{ color: 'var(--vscode-errorForeground)' }}>
              (<span style={{ fontWeight: 500 }}>Note:</span> Apex uses complex
          ...
          >
            ...
            {vsCodeLmModels.length > 0 ? (
              ...
              >
                ...
                Copilot extension from the VS Marketplace and enabling Claude
                3.7 Sonnet.
              </p>
            )}
      ...
      {selectedProvider === 'litellm' && (
        <div>
          ...
          >
            LiteLLM provides a unified interface to access various LLM
            providers' models. See their{' '}
            <VSCodeLink
      ...
      {selectedProvider === 'xai' && (
        <div>
          ...
          {/* Note: To fully implement this, you would need to add a handler in ApexProvider.ts */}
          {/* {apiConfiguration?.xaiApiKey && (
						<button
							onClick={() => {
								vscode.postMessage({
      ...
      {(selectedProvider === 'openrouter' || selectedProvider === 'apex') &&
        showModelOptions && (
          <>
            <VSCodeCheckbox
              style={{ marginTop: -10 }}
