			...
			<div
				...
				<div style={{ marginBottom: 5 }}>
					...
					<p
						...
						Help improve Apex by sending anonymous usage data and error reports. No code, prompts, or personal
						information are ever sent. See our{" "}
						<VSCodeLink href="https://docs.apex.bot/more-info/telemetry" style={{ fontSize: "inherit" }}>
							telemetry overview
						</VSCodeLink>{" "}
						and{" "}
						<VSCodeLink href="https://apex.bot/privacy" style={{ fontSize: "inherit" }}>
							privacy policy
						</VSCodeLink>{" "}
						for more details.
					</p>
				...
				<div
					...
					<p
						...
						<VSCodeLink href="https://github.com/apex/apex" style={{ display: "inline" }}>
