...
export const VSC_LIST_SELECTION_BACKGROUND =
  '--vscode-list-activeSelectionBackground';
export const VSC_FOCUS_BORDER = '--vscode-focus-border';
export const VSC_LIST_ACTIVE_FOREGROUND =
...
export const VSC_DIFF_REMOVED_LINE_BACKGROUND =
  '--vscode-diffEditor-removedLineBackground';
export const VSC_DIFF_INSERTED_LINE_BACKGROUND =
  '--vscode-diffEditor-insertedLineBackground';
export const VSC_INACTIVE_SELECTION_BACKGROUND =
  '--vscode-editor-inactiveSelectionBackground';
export const VSC_TITLEBAR_INACTIVE_FOREGROUND =
