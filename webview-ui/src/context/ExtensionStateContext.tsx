...
export const ExtensionStateContextProvider: React.FC<{
  ...
  const contextValue: ExtensionStateContextType = {
    ...
    setShowAnnouncement: useCallback((value) => {
      ...
      })); // Assuming value=true means hide it
      if (!value) {
    ...
    deleteCustomInstruction: useCallback((instructionId: string) => {
      vscode.postMessage({
        type: 'deleteCustomInstruction',
        text: instructionId,
      });
    }, []),
    setActiveCustomInstruction: useCallback((instructionId: string | null) => {
      vscode.postMessage({
        type: 'setActiveCustomInstruction',
        text: instructionId ?? undefined,
      }); // Send undefined if null
    }, []),
  };
