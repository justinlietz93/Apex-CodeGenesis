...
export class ApiRequestBuilder {
    ...
    async prepareRequestParameters() {
        ...
        if (await fileExistsAtPath(apexRulesFilePath)) {
            ...
            } catch (e) { console.error("Failed to read .apexrules", e); }
        }
        ...
        if (contextManagementMetadata.updatedConversationHistoryDeletedRange) {
            await this.task.stateManager.setConversationHistoryDeletedRange(contextManagementMetadata.conversationHistoryDeletedRange);
        }
