import { ApexMessage } from "./ExtensionMessage"

/**
 * Combines sequences of command and command_output messages in an array of ApexMessages.
 *
 * This function processes an array of ApexMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of ApexMessage objects to process.
 * @returns A new array of ApexMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: ApexMessage[]): ApexMessage[] {
	const combinedCommands: ApexMessage[] = []
