...
/**
 * Combines API request start and finish messages in an array of ApexMessages.
 *
 ...
 * @returns A new array of ApexMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: ApexMessage[]): ApexMessage[] {
	const combinedApiRequests: ApexMessage[] = []
