...
export async function regexSearchFiles(
	...
	// Filter results using ApexIgnoreController if provided
	const filteredResults = apexIgnoreController
		? results.filter((result) => apexIgnoreController.validateAccess(result.filePath))
		: results
