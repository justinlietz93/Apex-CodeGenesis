...
Place the `.apexrules` file in your project's root directory:
...
-   **Memory Check** - _pacnpal_
    ...
    A fun way to verify Apex stays on track during complex tasks. Try "HO HO HO" for a festive twist!
