# Apex Tools Reference Guide

## What Can Apex Do?

Apex is your AI assistant that can:
...
3. **Review Changes**
    - Apex will show diffs before making changes
...
3. **MCP Tools**
    ...
    - Users can create custom MCP tools that Apex can then access
    - Example: Create a weather API tool that Apex can use to fetch forecasts
